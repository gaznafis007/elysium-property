...
const Navbar = () => {
    ...
    return (
        <nav className="flex flex-row justify-between px-4 py-6 items-center border-b border-purple-800">
            ...
            <Image className="rounded-lg" src={'https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'} alt='profile-image' width={40} height={20}/>
        </nav>
    );
};
